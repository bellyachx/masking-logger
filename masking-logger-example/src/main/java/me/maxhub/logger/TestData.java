...
public class TestData {
    @Mask(using = ComplexStringSerializer.class)
    private String complexStringToSerialize;
    @Mask(using = ComplexObjectSerializer.class)
    ...
    @Mask(predicate = @Predicate(
        ...
        anyOf = {
            ...
            @Condition(property = "primitiveBoolean1", expression = ConditionExpression.EQUALS, expected = "true")
        }
    ))
    ...
    @Mask(propertyPaths = {"/value"})
    private VariableContainer variableContainer;
    private List<@Mask(propertyPaths = {
        "/value/varContainerKey1",
        "/value/varContainerKey2",
        "/value/varContainerKey3",
        "/value/varContainerKey4"
    }) VariableContainer> variableContainerList;
    ...
    @Mask(
        ...
        predicate = @Predicate(allOf = @Condition(property = "bigDecimal", expression = ConditionExpression.EQUALS, expected = "1000"))
    )
    private Object object;
    @Mask(propertyPaths = "/object")
    private ObjectContainer<String> objectContainer;
    private Map<String, @Mask(forKeys = "ABC1") String> map1;
    @Mask
    ...
    public static TestData buildTestData() {
        return TestData.builder()
            ...
            .variableContainerList(List.of(
                ...
                new VariableContainer("test", 123414123),
                new VariableContainer("test", 10),
                new VariableContainer("secret", "secret value"),
                new VariableContainer("secret", 1231231323),
                new VariableContainer("test", Map.of(
                    "varContainerKey1", "varContainerValue1",
                    "varContainerKey2", "varContainerValue2",
                    "varContainerKey3", "varContainerValue3",
                    "varContainerKey4", "varContainerValue4"
                ))
            ))
            ...
            .customObject(Map.of("customObjKey1", "value1", "customObjKey2", "value2"))
    ...
    public record ComplexObject(String string) {
    }
}
